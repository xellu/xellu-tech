...
<button onclick={() => {onclick()}} class="group w-[calc(100%+1px)]">
    ...
    <div class="flex items-center {label == '' || icon == null ? 'justify-center' : 'justify-between px-4'} gap-5 w-full h-12 -mt-12 lg:group-hover:translate-x-2 lg:group-hover:-translate-y-2 group-hover:shadow-2xl border duration-150 delay-75 {className}
